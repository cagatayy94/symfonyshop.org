        ...
        success: function(result) {
            if (result.success) {
                ...
                $.each(result.data, function(index, value) {
                    ...
                    if (value.id in productCategories) {
                        isChecked = "checked";
                    }else{
                        isChecked = "";
                    }
...
$('#iyzico-settings-form').on('submit', function (e) {
    e.preventDefault();
    e.stopPropagation();
...
$('#approve_the_order_form').on('submit', function (e) {
    e.preventDefault();
    e.stopPropagation();
...
$('#ship_the_order_form').on('submit', function (e) {
    e.preventDefault();
    e.stopPropagation();
