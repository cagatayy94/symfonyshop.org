...
try {
	...
	$mail->Host = 'retina.guzelhosting.com';				       // Specify main and backup server
	$mail->SMTPAuth = true;                                  // Enable SMTP authentication
	$mail->Username = 'deneme@webservis.ga';                    // SMTP username
	$mail->Password = 'iletisim21';                              // SMTP password
